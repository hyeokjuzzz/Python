...
#####################################################################
# # *ints 라는 가변인자 변수를 설정하여 intsum 을 함수 를 호출 할때 
# # N 개의 인수 를 전달하는예시
# def intsum(*ints) : 
#     sum = 0
#     for num in ints :
...
# sumCal(ivalue3 = 10, ivalue2=20, ivalue1=30)
...
# #  . 가변 인자 의 설정 은 **[변수명] 으로 한다.
# #  . 인수의 키워드 와 값은 각각 가변인자 튜플의 Key 와 Value 로 할당된다
###########################################################################
# #키워드 가변인수의 예시
# def calstep(**params) :
#     # 키워드 가면 인자의 속성 값 
...
#     sum = 0 
#     #for num in range(begin, end + 1, params[0]) : # index 로 호출 할 경우 오류
